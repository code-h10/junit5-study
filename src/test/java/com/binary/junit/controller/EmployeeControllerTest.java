...
public class EmployeeControllerTest {
    ...
    public void testEmployees() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/employees/detail").param("employeeNumber", "1003"))
                ...
                .andExpect(content().string("{\"employeeNumber\":1003,\"lastName\":\"Hwang\",\"firstName\":\"IlYoung\",\"extension\":\"x5024\",\"email\":\"test@gmail.com\",\"officeCode\":\"1\",\"reportsTo\":1002,\"jobTitle\":\"Sales Rep\"}"))
                .andDo(print());
    }
